...
const UraBadge = ({ className }: { className?: string }) => {
  return (
    <div
      className={cn(
...
export const MacbookScroll = ({
  ...
  const scaleX = useTransform(scrollYProgress, [0, 0.5], [1.2, isMobile ? 1 : 1.5]);
  const scaleY = useTransform(scrollYProgress, [0, 0.5], [0.6, isMobile ? 1 : 1.5]);
  ...
  return (
    <div
      ref={ref}
      className="relative flex min-h-[300vh] shrink-0 scale-[0.55] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-75 md:min-h-[400vh] md:scale-100 md:py-80"
    >
      {heading && (
        <motion.h2
          style={{
