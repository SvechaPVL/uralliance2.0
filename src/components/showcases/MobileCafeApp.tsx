  ...
  return (
    <div className="mx-auto w-[260px] rounded-[32px] border border-white/10 bg-[#05070c] p-3 text-white shadow-[0_20px_45px_rgba(0,0,0,0.45)]">
      <div className="rounded-[24px] border border-white/10 bg-[#080c14] p-4">
        <div className="text-xs uppercase tracking-[0.3em] text-white/60">Coffee Club</div>
        <div className="mt-4 h-36 rounded-2xl bg-gradient-to-br from-[#0f172a] to-[#140c19]" />
          ...
          <div className="mt-3 space-y-2">
            {items.map((item, idx) => (
              <motion.div
                ...
                animate={{ borderColor: idx === active ? "#22d3ee" : "rgba(255,255,255,0.1)", scale: idx === active ? 1.02 : 1 }}
