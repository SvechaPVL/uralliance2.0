...
export function TelegramChat() {
  ...
  return (
    <div className="relative mx-auto h-[520px] w-[272px]">
      <div className="absolute inset-0 rounded-[34px] bg-gradient-to-b from-[#0c111b] via-[#05070c] to-[#010203] shadow-[0_25px_60px_rgba(0,0,0,0.6)]">
        <div className="flex h-full flex-col overflow-hidden rounded-[24px] bg-[#05070c] text-white border border-white/10">
          <div className="flex items-center gap-3 bg-[#0a0f18] px-4 py-3 text-sm">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0f8ab1]/15 text-xs font-semibold tracking-[0.3em] text-[#7dd3fc] border border-[#0f8ab1]/40">
              UA
            </div>
            ...
            {!prefersReducedMotion && (
              ...
              >
                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M4 4v6h6M20 20v-6h-6"></path>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 10a8 8 0 0113-3l1 1M19 14a8 8 0 01-13 3l-1-1"></path>
                </svg>
              </button>
            )}
          </div>
      ...
      >
              ...
              <div
                  className={cn(
                    ...
                    message.type === "user"
                      ...
                      : "rounded-bl-md bg-[#10121a] text-white/90 border border-white/5"
                  )}
              >
        ...
        <div className="flex items-center gap-3 bg-[#0a0f18] px-4 py-3 text-sm text-[#8ca3b8]">
          <div className="flex-1 rounded-full bg-[#050608] px-4 py-2 text-[#94a3b8] text-xs uppercase tracking-[0.3em]">
            Сообщение
          </div>
        ...
        <div className="absolute left-0 top-20 h-12 w-1 rounded-r-full bg-black/30" />
        <div className="absolute left-0 top-36 h-16 w-1 rounded-r-full bg-black/20" />
        <div className="absolute right-0 top-28 h-10 w-1 rounded-l-full bg-black/25" />
      </div>
    </div>
  );
}
