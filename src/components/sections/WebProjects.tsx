    ...
    <Section spacing="lg">
      <div className="max-w-5xl mx-auto px-4">
        <div className="mb-10 text-center">
          <Label size="sm" spacing="wider" tone="muted">{sectionsConfig.web_projects.label}</Label>
          <Heading as="h3" size="xl" weight="semibold" className="mt-4">{sectionsConfig.web_projects.heading}</Heading>
