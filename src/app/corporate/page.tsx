...
export const metadata: Metadata = {
  title: "Корпоративное право | Регистрация ООО под ключ | Uralliance Владивосток",
  description:
    "Корпоративное право во Владивостоке: регистрация ООО за 3 дня, сделки M&A, корпоративные споры, абонентское обслуживание. Опыт 22+ лет. Регистрация от 5 000 ₽.",
  keywords:
    "корпоративный юрист владивосток, регистрация ооо владивосток, корпоративное право владивосток, юридическое сопровождение бизнеса владивосток, сделки m&a владивосток, корпоративные споры владивосток, абонентское обслуживание юрист владивосток, внесение изменений егрюл владивосток, смена адреса ооо владивосток",
  alternates: {
    canonical: "/corporate",
  },
  openGraph: {
