...
export const metadata: Metadata = {
  title: "Ликвидация ООО во Владивостоке под ключ — от 10 000₽ | Юральянс",
  description:
    "Закрытие ООО и ликвидация организаций во Владивостоке. Юральянс: добровольная, упрощённая ликвидация. Публикации Федресурс + Вестник. Опыт 22+ лет. Официальный представитель Вестника госрегистрации.",
  keywords:
    "ликвидация ооо владивосток, закрытие ооо владивосток, ликвидация под ключ владивосток, закрыть фирму владивосток, ликвидация компании владивосток, добровольная ликвидация, упрощенная ликвидация, исключение из егрюл, юральянс ликвидация, ликвидация организации владивосток",
  alternates: {
