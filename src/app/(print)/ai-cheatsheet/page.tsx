...
const PROMPT_CATEGORIES = [
  {
    ...
    prompts: [
      ...
      },
      {
        ...
        prompt:
          "Напиши продающее описание для карточки товара на маркетплейсе [Wildberries/Ozon]. Товар: [название]. Выдели 5 ключевых преимуществ, добавь характеристики.",
      },
      {
        title: "Контент-план",
        prompt:
