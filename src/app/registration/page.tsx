...
export const metadata: Metadata = {
  title: "Регистрация ООО во Владивостоке под ключ | Открытие бизнеса | Uralliance",
  description:
    "Регистрация ООО и юридических лиц во Владивостоке под ключ за 3 дня. Внесение изменений в ЕГРЮЛ, аренда юр. адреса, открытие расчетного счета. Опыт 22+ лет. От 5 000 ₽.",
  keywords:
    "регистрация ооо владивосток, открыть ооо владивосток, регистрация юридического лица владивосток, открытие бизнеса владивосток, регистрация ооо под ключ владивосток, внесение изменений егрюл владивосток, смена адреса ооо владивосток, смена директора ооо владивосток, аренда юридического адреса владивосток, открыть расчетный счет владивосток",
  alternates: {
    canonical: "/registration",
  },
  openGraph: {
    title: "Регистрация ООО под ключ — от 5 000 ₽ за 3 дня",
    description:
      "Открытие бизнеса во Владивостоке. Регистрация ООО, внесение изменений в ЕГРЮЛ, аренда юр. адреса. Помогаем открыть расчетный счет на партнерских условиях.",
    type: "website",
    locale: "ru_RU",
    url: "/registration",
    siteName: "Uralliance",
          ...
          <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <Heading as="h1" size="3xl" weight="bold" className="leading-tight">
                <span className="text-[var(--color-legal-primary)]">Регистрация</span> бизнеса во
                Владивостоке
              </Heading>

              <Text size="lg" tone="secondary" className="max-w-xl leading-relaxed">
                Открываем ООО за 3 дня без госпошлины. Полное сопровождение: от выбора кодов ОКВЭД
                до открытия расчетного счета на партнерских условиях. Вы только подписываете — всё
                остальное делаем мы.
              </Text>
