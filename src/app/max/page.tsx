...
export const metadata: Metadata = {
  title: "Разработка ботов для MAX мессенджера — Mini Apps, чат-боты | Юральянс",
  description:
    "Заказать бота для мессенджера MAX во Владивостоке. Юральянс: разработка чат-ботов, Mini Apps, каналов MAX. Автоматизация бизнеса, приём заказов, интеграция с CRM. Официальные партнёры MAX.",
  keywords:
    "разработка бота max, заказать бота max, max мессенджер бот, mini apps max, чат бот max владивосток, создание бота max, мини приложения max, автоматизация max, бот для бизнеса max, разработка чат бота владивосток, юральянс боты",
  alternates: {
    canonical: "/max",
  },
  openGraph: {
