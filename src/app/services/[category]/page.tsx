...
const HERO_CONFIG = {
  legal: {
    ...
    description:
      "Представляем бизнес в суде, помогаем с налогами, регистрируем и ликвидируем юрлица, ведём бухгалтерию. Официальный представитель «Вестника государственной регистрации» в Приморском крае. Индивидуальный подход к каждому клиенту.",
    primaryCta: { href: "/#contact", label: "Консультация" },
    highlights: [
      { label: "Работа с юр. лицами", value: "22+ года" },
      { label: "Налоговые споры", value: "50+/год" },
      { label: "Журнал «Вестник»", value: "Официальный представитель" },
    ],
    supporting: [
      "Регистрация, реорганизация и ликвидация юридических лиц, публикации и изменения в ЕГРЮЛ.",
      "Подготовка к налоговым проверкам, сопровождение коммуникации с ФНС и обжалования.",
      "Бухгалтерское обслуживание для ИП и ООО.",
      "Официальные представители журнала «Вестник» в Приморском крае.",
      "Представляем интересы в арбитраже и судах общей юрисдикции от претензии до исполнительного производства.",
    ],
  },
  tech: {
...
const SERVICE_BULLETS = {
  legal: [
    ...
    "Регистрация, реорганизация и ликвидация юрлиц. Бухгалтерское обслуживание. Публикации в журнале «Вестник» и Федресурс.",
  ],
  tech: [
