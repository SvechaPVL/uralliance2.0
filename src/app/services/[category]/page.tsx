...
const HERO_CONFIG = {
  legal: {
    ...
    description:
      "Представляем бизнес в суде, помогаем с налогами, регистрируем и ликвидируем юрлица, ведём бухгалтерию. Официальный представитель «Вестника государственной регистрации» во Владивостоке. Индивидуальный подход к каждому клиенту.",
    ...
    supporting: [
      ...
      "Официальные представители «Вестника государственной регистрации» во Владивостоке.",
    ],
  },
  tech: {
