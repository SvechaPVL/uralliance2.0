...
export const metadata: Metadata = {
  title: "Дополнительные услуги для бизнеса во Владивостоке | Юральянс",
  description:
    "Юральянс — дополнительные услуги для бизнеса во Владивостоке: электронные подписи, юридические адреса, экспертизы, публикации в официальных изданиях. Партнёрство с ведущими банками.",
  keywords:
    "дополнительные услуги для бизнеса владивосток, юридический адрес владивосток, электронная подпись владивосток, экспертиза документов владивосток, юральянс услуги",
};
