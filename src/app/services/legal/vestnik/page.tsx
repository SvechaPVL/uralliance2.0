...
export const metadata: Metadata = {
  title:
    "Публикация в Вестнике госрегистрации во Владивостоке | Официальный представитель | Uralliance",
  description:
    "Официальное региональное представительство журнала «Вестник» в Приморском крае. Публикация уведомлений о ликвидации, реорганизации, уменьшении уставного капитала.",
  keywords:
    "вестник госрегистрации владивосток, официальный представитель вестник приморский край, публикация о ликвидации ооо владивосток, публикация в вестнике владивосток, уведомление в вестнике владивосток, публикация о реорганизации владивосток, ликвидация ооо владивосток",
  alternates: {
    canonical: "/services/legal/vestnik",
  },
  openGraph: {
    title: "Публикация в Вестнике госрегистрации — официальный представитель в Приморском крае",
    description:
      "ООО «ЮрАльянс» — официальное региональное представительство журнала «Вестник» в Приморском крае.",
    type: "website",
    locale: "ru_RU",
