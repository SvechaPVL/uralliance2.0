...
export const metadata: Metadata = {
  ...
  description:
    "Купить рутокен и получить электронную подпись во Владивостоке. Рутокен ЭЦП 3.0, 2.0, Lite, JaCarta. Лицензии КриптоПро. Скидки пенсионерам.",
  keywords:
    "рутокен владивосток, эцп владивосток, купить рутокен, электронная подпись, криптопро владивосток, рутокен эцп 3.0, рутокен эцп 2.0, jacarta владивосток",
  alternates: {
    canonical: "/ecp",
  },
  openGraph: {
    ...
    description:
      "Купить рутокен и получить электронную подпись. Рутокен ЭЦП 3.0, 2.0, Lite. Лицензии КриптоПро.",
    type: "website",
    locale: "ru_RU",
    url: "/ecp",
    siteName: "Uralliance",
...
const RUTOKEN_PRICES = [
  {
    name: "Рутокен ЭЦП 3.0 NFC",
    price: 3500,
    description: "С поддержкой бесконтактной передачи",
    badge: "Топ продаж",
    features: ["NFC", "Усиленная криптография", "ГОСТ 2012"],
  },
  {
  ...
  },
  {
    ...
    price: 2500,
    description: "Для госзакупок и ФНС",
    badge: "Популярный",
    features: ["ГОСТ 2012", "USB-A", "Для торгов"],
  },
  {
    name: "Рутокен ЭЦП 2.0 micro/Type-C",
    price: 3000,
    description: "Компактный формат",
    features: ["ГОСТ 2012", "Type-C/micro", "Компактный"],
  },
  {
    name: "Рутокен Lite",
    price: 1500,
  ...
  },
  {
    name: "JaCarta-2",
    price: 2000,
    description: "Альтернативный носитель",
    features: ["USB-A", "Совместимый", "Сертифицирован"],
  },
];
