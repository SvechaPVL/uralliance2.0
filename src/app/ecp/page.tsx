...
export const metadata: Metadata = {
  ...
  description:
    "Купить рутокен и получить электронную подпись во Владивостоке. Рутокен ЭЦП 3.0, Lite, JaCarta. Лицензии КриптоПро. Скидки пенсионерам.",
  keywords:
    "рутокен владивосток, эцп владивосток, купить рутокен, электронная подпись, криптопро владивосток, рутокен эцп 3.0, рутокен лайт, jacarta владивосток",
  alternates: {
    canonical: "/ecp",
  },
  openGraph: {
