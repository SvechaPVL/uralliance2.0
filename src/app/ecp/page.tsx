...
export const metadata: Metadata = {
  title: "Купить рутокен и ЭЦП во Владивостоке — Электронная подпись | Юральянс",
  description:
    "Купить рутокен и получить электронную подпись (ЭЦП) во Владивостоке. Юральянс: Рутокен ЭЦП 3.0, Lite, КриптоПро. Токен для электронной подписи от 3 000₽. Скидки пенсионерам.",
  keywords:
    "купить рутокен владивосток, эцп владивосток, электронная подпись владивосток, токен для эцп, криптопро владивосток, рутокен эцп 3.0, получить эцп владивосток, носитель для электронной подписи, юральянс эцп",
  alternates: {
    canonical: "/ecp",
  },
  openGraph: {
