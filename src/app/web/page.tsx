...
export const metadata: Metadata = {
  title: "Создание сайтов во Владивостоке под ключ — от 15 000₽ | Юральянс",
  description:
    "Заказать сайт во Владивостоке в Юральянс: лендинги, корпоративные сайты, интернет-магазины на React/Next.js. Веб-студия с опытом. Разработка сайтов под ключ от 15 000₽. Консультация бесплатно.",
  keywords:
  ...
  openGraph: {
    title: "Разработка сайтов — от 15 000 ₽",
    description:
