...
export const metadata: Metadata = {
  title: "Такском ЭДО и электронная отчётность во Владивостоке | Юральянс",
  description:
    "Подключение к Такском во Владивостоке. Юральянс: электронная отчётность в ФНС, СФР, Росстат. ЭДО с контрагентами, Онлайн-Спринтер, Файлер 2.0. Сдача отчётности от 3 000₽/год.",
  keywords:
    "такском владивосток, эдо владивосток, электронная отчетность владивосток, электронный документооборот, сдача отчетности владивосток, онлайн спринтер, файлер, 1с эдо, эдо для бизнеса, юральянс такском",
  alternates: {
    canonical: "/edo",
  },
  openGraph: {
